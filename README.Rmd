...
The purpose of this clean probe set is to be used **bioinformatically** to recover targeted sequences from sequencing reads, but not to physically target the sequences in vitro.
