# ALIGN TRANSLATED NUCLEOTIDES TO REFERENCE AND DRAW CONSENSUS --------------------------------------------------------
# Needs 5 arguments:
...
#args = c("Tibouchina-AT5G67530_hits_to_align.FNA", "Tibouchina-AT5G67530_hits_aligned_to_ref.FNA", "IDs_to_remove_after_alignment.txt", "Tibouchina-AT5G67530_hits_consensus", "Tibouchina-AT5G67530_hits_consensus.FNA")
# load the arguments
...
#readLines("IDs_to_remove_after_alignment.txt")
#paste(readLines(args[3]), collapse = "|")
#aligned_no_ref <- aligned[- grep(pattern = args[3], x = names(aligned))]
